...
public class Tama extends Leny {
    ...
    private void kiir_allapot(){
        try {
            ...
            System.err.println("A fájlban irás sikertelen");
        }
...
private void probal_olvas_allapot()
    throws FileNotFoundException{
        File f =new File("allapot.txt");
        Scanner sc=new Scanner(f);
        String ehesSTR=sc.nextLine();
        this.ehseg=Integer.parseInt(ehesSTR);
        sc.close();
    }
}
